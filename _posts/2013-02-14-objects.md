---
number: 65
title: "Objects _are_ the API, stupid!"
summary: Shared objects in Node.js applications
date: 2013-02-14T19:15+00:00
lanyrd: http://lanyrd.com/2013/asyncjs-objects/
speakers:
- name: Kevin Jones
  link: 
image:
...
In this talk, Kevin Jones will look at how to use the new features by example and show how he built a _shared object_ module for distributed Node.js applications that exploits meta-programming ideas to make it absurdly easy to use.
